/* Parity: the snippet's inlined 24-language table MUST match the shared
...
import { STRINGS, ACRONYM as SHARED_ACRONYM, EU_LOCALES } from '../../shared/src/i18n.ts';
...
test('snippet covers all 24 EU locales, no extras', () => {
  assert.deepEqual(Object.keys(I18N).sort(), [...EU_LOCALES].sort());
});
